...
clean-docs: ## remove docs artifacts
	rm -f docs/apidoc/nbgrader_jupyterquiz*.rst
...
coverage: ## check code coverage quickly with the default Python
	python -m coverage run --source src/nbgrader_jupyterquiz -m pytest
...
autodoc: clean-docs ## create sphinx-apidoc files:
	sphinx-apidoc -o docs/apidoc --private --module-first src/nbgrader_jupyterquiz
